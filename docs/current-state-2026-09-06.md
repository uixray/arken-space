...
Последняя сверка: **6 сентября 2026 года**.

## Активный release gate — UIX-642

PR #58–67 объединены в `codex/uix-642-release` без конфликтов, исходный main
`f1a66c835b7915a68dbc3a287f0ae358efb656ae`. Точные головы, решения, изменения и
следующий gate: [checkpoint UIX-642](plans/uix-642-release.md).

Публикация GitHub и production разрешена владельцем. PR #67 опубликован;
checks/e2e/multiplayer SUCCESS, но один flaky смены игрока явно отложен, а не
объявлен исправленным. Следующий шаг — CI объединённого PR и нового main SHA,
затем backup/restore, non-live media smoke и штатный двухфазный release.
Production пока остаётся на `f1a66c8`. UIX-217 и mobile P2–P6 не закрываются.

Ниже сохранён **исторический снимок 5 сентября**: упоминания красного PR #63
и отсутствия разрешения на публикацию больше не описывают текущий gate.
